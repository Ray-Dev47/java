...
public class Airplane{
      ...
      public  Airplane(String flightNumber, String destination, LocalDate depatureTime, int delayTime){
    ...
    public Airplane(String string, String string2, LocalTime of) {
      }
    ...
    public void delay(int minutes) {
      ...
      this.depatureTime = this.depatureTime.plusMinutes(minutes);
    }
